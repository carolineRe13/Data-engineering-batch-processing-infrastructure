...
@description('This is the headnode Azure Virtual Machine size, and will affect the cost.')
@allowed([
  'Standard_A4_v2'
  'Standard_A8_v2'
  'Standard_E2_v3'
...
param headNodeVirtualMachineSize string = 'Standard_E2_v3'

@description('This is the workernode Azure Virtual Machine size, and will affect the cost.')
@allowed([
  'Standard_A4_v2'
  'Standard_A8_v2'
  'Standard_E2_v3'
...
param workerNodeVirtualMachineSize string = 'Standard_E2_v3'
